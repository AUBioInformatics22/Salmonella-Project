...
if(test==1){
    ...
    input <- "~/scratch/AU_BIOL_6860_Salmonella/step_4_Andrea4/SRR10740742.SNPs.filtered.vcf"
...
RPRS.plot <- RPRS.plot + ggtitle("ReadPosRankSum - Negative values indicate ALT near ends (cutoff -8)")

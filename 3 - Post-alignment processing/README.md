...
The script produces an overview file with the statistics for each sample: [2022_04_09_markdup_stats.txt](https://github.com/AUBioInformatics22/Salmonella-Project/blob/main/3%20-%20Post-alignment%20processing/2022_04_09_markdup_stat.txt). With these results the percentage of duplication was calculated using the formula (number of duplicates / number of reads in total )x100. The results were saved in the files [dup.csv](https://github.com/AUBioInformatics22/Salmonella-Project/blob/main/3%20-%20Post-alignment%20processing/dup.csv).
